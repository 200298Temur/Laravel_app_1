              ...
              <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class='row mb-4'>
                        ...
                        <form action="{{ route('posts.destroy', ['post' => $post->id]) }}" method="POST" onsubmit="return confirm('Postni o\'chirishni hohlayszmi?');"> 
                            @csrf
                            @method('DELETE')
                    ...
                    @endauth
                      <div class="mb-5">
                        <div class="d-flex mb-2">
                          ...
                          <div class="d-flex mb-2">
                            <a class="text-white bg-secondary rounded py-1 px-2 font-weight-medium">{{ $post->category->name }}</a>
                        </div>
                    ...
                    Comment start
                      ...
                      <div class="bg-light rounded p-5">
                          <h3 class="mb-4 section-title">Izoh qoldirish</h3>
                            ...
                            @else
                            <a href="{{ route('login') }}">Siz ro'yxatdan o'tmagansiz!</a>
                            @endauth
                      </div>
                  </div>
